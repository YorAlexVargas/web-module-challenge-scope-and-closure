...
function processFirstItem(stringList, callback) {
  ...
  *
  * Bothe Counter 1 and counter 2 work the same way, but 1 is a higher function, and in a closure
  * While counter 2 does not.
  *
  * 2. Which of the two uses a closure? How can you tell?
  *
  * Counter 1 is in a closure. the seond count is scope
  *
 ...
 */
 function finalScore(cb,numInning){
 let home = 0;
 let away = 0;
